...
class analyser_merge_advertising_board_FR_Brest(Analyser_Merge_Point):
    def __init__(self, config, logger=None):
        ...
        self.def_class_missing_osm(item=7361, id=2, level=3, tags=['merge', 'public equipment', 'fix:survey', 'fix:picture'],
                                   title=T_('Advertising board in OSM but not in OpenData'))
        self.def_class_possible_merge(item=8361, id=3, level=3, tags=['merge', 'public equipment', 'fix:survey', 'fix:picture'],
